(function() {
  var CSON, Disposable, Emitter, EmitterMixin, Grammar, GrammarRegistry, Grim, NullGrammar, _, ref;
  ...
  module.exports = GrammarRegistry = (function() {
    function GrammarRegistry(options) {
      ...
      this.maxTokensPerLine = (ref1 = options.maxTokensPerLine) != null ? ref1 : Infinity;
      this.maxLineLength = (ref2 = options.maxLineLength) != null ? ref2 : Infinity;
    ...
    GrammarRegistry.prototype.readGrammarSync = function(grammarPath) {
      var grammar, ref1;
      grammar = (ref1 = CSON.readFileSync(grammarPath)) != null ? ref1 : {};
    ...
    GrammarRegistry.prototype.decodeTokens = function(lineText, tags, scopeTags, fn) {
      var expectedScopeName, i, index, len, offset, poppedScopeName, scopeNames, tag, token, tokens;
      if (scopeTags == null) {
        scopeTags = [];
      }
      offset = 0;
